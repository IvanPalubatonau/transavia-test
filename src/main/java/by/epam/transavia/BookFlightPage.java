...
public class BookFlightPage extends BasePage {
	...
	private WebElement attantionMessage;
	...
	public String getAttantionMessage() {
		
		WebDriverWait wait = new WebDriverWait(driver, 10);
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='flights']/div/section/div[2]/div[1]/div/div/div[1]/div/div/div[2]/p")));
		String message = attantionMessage.getAttribute("innerHTML");
		return message;
